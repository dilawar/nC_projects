...
#define usetable usetable_KConductance
 ...
 "usetable_KConductance", &usetable_KConductance,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 4);
 	...
 	ivoc_help("help ?1 KConductance /home_local/dilawars/nC_projects/Ex3_Morphology_copy/generatedNEURON/x86_64/KConductance.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _ltemp_adj_n , _lA_alpha_n , _lB_alpha_n , _lVhalf_alpha_n , _lA_beta_n , _lB_beta_n , _lVhalf_beta_n ;
  _ltemp_adj_n = 1.0 ;
   _lA_alpha_n = 0.1 ;
   _lB_alpha_n = 10.0 ;
   _lVhalf_alpha_n = - 55.0 ;
   _lalpha = _lA_alpha_n * vtrap ( _threadargscomma_ ( _lv - _lVhalf_alpha_n ) , _lB_alpha_n ) ;
   _lA_beta_n = 0.125 ;
   _lB_beta_n = - 80.0 ;
   _lVhalf_beta_n = - 65.0 ;
   _lbeta = _lA_beta_n * exp ( ( _lv - _lVhalf_beta_n ) / _lB_beta_n ) ;
