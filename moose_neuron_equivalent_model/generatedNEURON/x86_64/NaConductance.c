...
#define usetable usetable_NaConductance
 ...
 "usetable_NaConductance", &usetable_NaConductance,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 4);
 	...
 	ivoc_help("help ?1 NaConductance /home_local/dilawars/nC_projects/Ex3_Morphology_copy/generatedNEURON/x86_64/NaConductance.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _ltemp_adj_m , _lA_alpha_m , _lB_alpha_m , _lVhalf_alpha_m , _lA_beta_m , _lB_beta_m , _lVhalf_beta_m , _ltemp_adj_h , _lA_alpha_h , _lB_alpha_h , _lVhalf_alpha_h , _lA_beta_h , _lB_beta_h , _lVhalf_beta_h ;
  _ltemp_adj_m = 1.0 ;
   _ltemp_adj_h = 1.0 ;
   _lA_alpha_m = 1.0 ;
   _lB_alpha_m = 10.0 ;
   _lVhalf_alpha_m = - 40.0 ;
   _lalpha = _lA_alpha_m * vtrap ( _threadargscomma_ ( _lv - _lVhalf_alpha_m ) , _lB_alpha_m ) ;
   _lA_beta_m = 4.0 ;
   _lB_beta_m = - 18.0 ;
   _lVhalf_beta_m = - 65.0 ;
   _lbeta = _lA_beta_m * exp ( ( _lv - _lVhalf_beta_m ) / _lB_beta_m ) ;
   mtau = 1.0 / ( _ltemp_adj_m * ( _lalpha + _lbeta ) ) ;
   minf = _lalpha / ( _lalpha + _lbeta ) ;
   _lA_alpha_h = 0.07 ;
   _lB_alpha_h = - 20.0 ;
   _lVhalf_alpha_h = - 65.0 ;
   _lalpha = _lA_alpha_h * exp ( ( _lv - _lVhalf_alpha_h ) / _lB_alpha_h ) ;
   _lA_beta_h = 1.0 ;
   _lB_beta_h = - 10.0 ;
   _lVhalf_beta_h = - 35.0 ;
   _lbeta = _lA_beta_h / ( exp ( ( _lv - _lVhalf_beta_h ) / _lB_beta_h ) + 1.0 ) ;
...
double vtrap ( _threadargsprotocomma_ double _lVminV0 , double _lB ) {
   double _lvtrap;
