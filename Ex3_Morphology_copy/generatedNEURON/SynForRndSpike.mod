COMMENT
   ...
   **************************************************
   ...
   SynForRndSpike (Type: Synaptic mechanism, Model: Template based ChannelML file)

   with parameters: 
   /channelml/@units = Physiological Units 
   /channelml/notes = ChannelML file describing a single synaptic mechanism 
   /channelml/synapse_type/@name = SynForRndSpike 
...
// File from which this was generated: /home_local/dilawars/nC_projects/Ex3_Morphology_copy/cellMechanisms/SynForRndSpike/DoubExpSyn.xml

// XSL file with mapping to simulator: /home_local/dilawars/nC_projects/Ex3_Morphology_copy/cellMechanisms/SynForRndSpike/ChannelML_v1.8.1_NEURONmod.xsl
